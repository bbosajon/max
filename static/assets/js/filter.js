                                        ...
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="/product-details/${product.PRDSlug}">
                                                    <img class="default-img" src="https://maxmedia.blob.core.windows.net/media/${product.product_image}" width="182" height="182" style="width:182px;height:182px;" alt="${product.product_name}" />
                                                    <img class="hover-img" src="https://maxmedia.blob.core.windows.net/media/${product.product_image}" width="182" height="182" style="width:182px;height:182px;" alt="${product.product_name}" />
                                                </a>
                                            </div>
